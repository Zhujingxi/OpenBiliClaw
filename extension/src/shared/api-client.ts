...
export type CompleteSourceTask = { "failure"?: SourceTaskFailure | null; "lease_token": string; "result"?: BrowserBootstrapResult | BrowserSearchResult | BrowserTrendingResult | BrowserFeedResult | BrowserRelatedResult | BrowserCreatorResult | BrowserCommunityResult | null; };
...
export type InteractionResponse = { "interaction": Interaction; "signal": ProfileSignal | null; };
...
export type SourceTaskFailure = { "code": "claim_mismatch" | "operation_mismatch" | "result_mismatch" | "deadline_exceeded" | "execution_failed"; "error_type": string; };
