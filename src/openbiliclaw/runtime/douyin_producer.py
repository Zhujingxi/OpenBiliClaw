...
# Plugin discovery is not a cheap stateless request: one failed attempt can
# occupy a real browser tab for several minutes. Keep infrastructure failures
# from being retried on every refresh tick while still letting a genuine empty
# page retry at the configured (shorter) source interval.
