const handledProbeKeys = /* @__PURE__ */ new Set();
...
export function filterVisibleProbes(items, type = "interest.probe") {
  return Array.isArray(items) ? items.filter((item) => shouldHydrateProbe(item, type)) : [];
}
...
//# sourceMappingURL=probe-notification-helpers.js.map
