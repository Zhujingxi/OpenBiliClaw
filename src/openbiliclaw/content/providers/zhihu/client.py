"""Typed injected Zhihu transport boundary."""
...
from .models import ZhihuItem, ZhihuPage
...
class ZhihuClient:
    def __init__(self, transport: ZhihuTransport, resolver: CredentialResolver) -> None:
        self._transport, self._resolver = transport, resolver

    def __repr__(self) -> str:
        return "ZhihuClient(credentials=<opaque>)"
