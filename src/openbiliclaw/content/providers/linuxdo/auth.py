"""Provider-owned LinuxDo manual-cookie form and verifier."""
...
LINUXDO_CONNECTION_FORM = ConnectionForm(
    provider_id="linuxdo",
...
class LinuxDoCredentialVerifier:
    ...
    async def __call__(
        ...
        try:
            ...
            if "_t=" not in submission.cookie:
