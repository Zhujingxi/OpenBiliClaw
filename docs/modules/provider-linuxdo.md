...
Plan 07 的 typed first-party `linuxdo` provider 已落地于 `content/providers/linuxdo/`。

- Access: manual _t cookie；secret 只经 Provider Access vault resolver 在 trusted client boundary 解析。
