# RedNote / Xiaohongshu Content Provider（目标包，尚未接入生产组合根）
...
Legacy `sources/xhs_*` / `xiaohongshu_adapter.py` 继续服务当前 production graph，等待 Plans 10–15 caller/composition cutover；本包没有 browser automation、Cookie extraction、compatibility facade 或双写。
