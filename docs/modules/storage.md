...
| 九平台来源族归一化 | ✅ | `sources.platforms` 以可枚举规则统一 Bilibili、小红书、抖音、YouTube、X、知乎、Reddit、Bangumi、Linux.do 的别名、策略前缀和 URL host；pool accounting、已看身份与 URL 推断共用同一口径。 |
