...
| SoulEngine 全局模型路由 | ✅ | 构造时接收 production `RuntimeModelBundle.chat_route` 与稳定 gate；preference / awareness / insight / profile_builder / speculator / dialogue_insight 全部遵循同一 ordered route，caller tag 只用于并发与 usage |
