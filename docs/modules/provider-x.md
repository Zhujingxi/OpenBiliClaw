...
- Access: a manual `auth_token` + `ct0` cookie form is registered, but the production verifier probe and HTTP transport are unavailable; new connections and live reads fail closed.
