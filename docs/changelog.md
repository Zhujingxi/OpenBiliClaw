...
- **发布状态**：后端 / 插件 / 桌面安装包与聚合 Release 均发布为 `v0.3.208`，详情见 [Release](https://github.com/whiteguo233/OpenBiliClaw/releases)。Chrome Web Store 已上传 `0.3.208` 并进入 `PENDING_REVIEW`；Firefox AMO 已提交（若发布）。聚合 Latest Release 已附两份扩展 ZIP 与四份桌面安装器。
