...
| Target Frontend Workspace | [modules/frontend.md](modules/frontend.md) | `frontend/packages/` | 🚧 API client + shared Presentation Contract/cards 已落地，web/extension shells 尚未切换 |
