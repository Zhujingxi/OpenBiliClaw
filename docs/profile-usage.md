...
| --- | --- | --- | --- | --- | --- |
| Recommendation evaluation / expression | Per candidate (discovery + serve) | `compact_content_prompt_profile_summary(build_profile_summary(...))` — `recommendation/engine.py:126-127` | compact (20 core / 80 interests / 32 domains × 16 specifics / 12 recent; dislikes uncapped) | No | Yes |
