...
class TestOriginAllowed:
    ...
    def test_same_site_https_origin_allowed(self) -> None:
        assert _origin_allowed("https://myhost:8443") is True
        assert _origin_allowed("https://192.168.1.100:8443") is True
    ...
    def test_http_same_host_allowed(self) -> None:
        # http://<host>:8443 is allowed (proxy forwards to backend which accepts http)
        assert _origin_allowed("http://myhost:8443") is True
...
class TestRewriteOrigin:
    ...
    def test_https_rewritten_to_http(self) -> None:
        assert _rewrite_origin("https://myhost:8443") == "http://myhost:8443"
    ...
    def test_http_origin_unchanged(self) -> None:
        assert _rewrite_origin("http://myhost:8443") == "http://myhost:8443"
