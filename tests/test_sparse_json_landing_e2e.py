...
_HISTORICAL_PRODUCTION_SYSTEM_SHA256 = (
    "7391051b8745fc53a71c1795ae4410e73aa2bd472f37307fda9bed54a1379299"
)
_HISTORICAL_PRODUCTION_USER_SHA256 = (
    "0594d43d1e4905922d41b6f4b2328f86810e578eec2de351f724be16a9840c24"
)
...
@pytest.mark.asyncio
async def test_default_engine_uses_sparse_local_ids_on_cold_and_warm_prompt_path() -> None:
...
@pytest.mark.asyncio
async def test_explicit_production_rollback_matches_frozen_historical_prompt_hashes() -> None:
